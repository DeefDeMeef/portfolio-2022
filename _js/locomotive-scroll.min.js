!(function (t, e) {
      ...
      (function (t, e) {
        ...
        try {
          for (
            ...
            !(s = (l = r.next()).done) && (i.push(l.value), !e || i.length !== e);
            s = !0
          );
        } catch (t) {
          (n = !0), (o = t);
        ...
        i(e, [
          ...
          },
          {
            ...
            value: function (t) {
              t.preventDefault(),
                this.scrollTo(
                  t.currentTarget.getAttribute("data-".concat(this.name, "-href")) ||
            ...
            value: function (t, e) {
              (this.els[e].inView = !0),
                ...
                t.call &&
                  ...
                  (this.dispatchCall(t, "enter"), t.repeat || (this.els[e].call = !1));
            },
          },
          {
            key: "setOutOfView",
        ...
        function n() {
          ...
          return (
            ...
            void 0 === window.smoothscrollPolyfill &&
              ((window.smoothscrollPolyfill = S), window.smoothscrollPolyfill.polyfill()),
            e
          );
        }
        return (
          i(n, [
            ...
            },
            {
              ...
              value: function () {
                window.pageYOffset != this.instance.scroll.y
                  ? (this.instance.speed =
                      (window.pageYOffset - this.instance.scroll.y) / Math.max(1, Date.now() - this.speedTs))
                ...
                (this.els = {}),
                  this.el.querySelectorAll("[data-" + this.name + "]").forEach(function (e, i) {
                    ...
                    var s,
                      ...
                      u = (o =
                        void 0 !== d ? document.querySelector("".concat(d)) : e).getBoundingClientRect();
  ...
  (V.prototype._notify = function (t) {
    ...
    (e.x += e.deltaX),
      (e.y += e.deltaY),
      this._emitter.emit(H, { x: e.x, y: e.y, deltaX: e.deltaX, deltaY: e.deltaY, originalEvent: t });
  }),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              this.isDraggingScrollbar &&
                requestAnimationFrame(function () {
                  var i =
                      (((100 * (t.clientX - e.scrollbarBCR.left)) / e.scrollbarWidth) * e.instance.limit.x) /
                      100,
                    s =
                      (((100 * (t.clientY - e.scrollbarBCR.top)) / e.scrollbarHeight) * e.instance.limit.y) /
                      100;
            ...
            value: function () {
              ...
              0 === e.length && (e = [this.el]),
                e.forEach(function (e, i) {
                  var s =
                      "string" == typeof e.dataset[t.name + "Id"] ? e.dataset[t.name + "Id"] : "section" + i,
